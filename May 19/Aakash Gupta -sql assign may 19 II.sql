...
--16
--inserting  a test product realesed 4 days ago beccause no other product is relased 10 days before so empty output
insert into ProductInventory values ('Laptop Test product', 'Electronics', 200, 70000, 'TechMart', '2025-05-15');

select * from ProductInventory where LastRestocked between GETDATE()-10 and GETDATE();

--delete the test data
delete from ProductInventory where ProductName='Laptop Test product';
...
--database checking commnad (for self use)
